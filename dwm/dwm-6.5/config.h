...
/* include files for volume control and language switch*/
...
void togglelang(const Arg *arg) {
    system("setxkbmap -layout us,br -option 'grp:win_space_toggle'");
}
...
/* key definitions */
#define MODKEY Mod1Mask // 4 is windows key
...
static const char *printcmd[] = { "ksnip", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_z,      spawn,          {.v = filescmd } },
	{ 0,                            XK_Print,  spawn,          {.v = printcmd } },
	{ 0,             XF86XK_AudioLowerVolume,  spawn,          {.v = downvol } },
	{ 0,             XF86XK_AudioMute,         spawn,          {.v = mutevol } },
	{ 0,             XF86XK_AudioRaiseVolume,  spawn,          {.v = upvol   } },
	{ Mod4Mask,                     XK_space,  togglelang,     {0} },
